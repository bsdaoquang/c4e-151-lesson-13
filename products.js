...
const products =
  ...
  const handleListProducts = () => {
      ...
      const descrtiption = document.createElement('p')
      const img = document.createElement('img')

      cardContent.setAttribute('class', 'card')
      body.setAttribute('class', 'card-body')
      
      img.src= 'https://gamelade.vn/wp-content/uploads/2024/01/Luffy-Gear-5-1024x576.webp'

      container.setAttribute('class', 'product-content  col-lg-3 col-md-6 col-sm-12')

      title.innerHTML = product.title
      title.setAttribute('class', 'product-title')
      descrtiption.innerHTML = product.body
      descrtiption.setAttribute('class', 'text-muted')
      descrtiption.setAttribute('class', 'description')

      cardContent.appendChild(img)
      body.appendChild(title)
      body.appendChild(descrtiption)
